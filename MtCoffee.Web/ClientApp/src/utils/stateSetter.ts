...
export const forceUpdateAsync = (component: React.Component) => new Promise(resolve => component.forceUpdate(() => resolve(undefined)));
export const forceUpdateAsyncFactory = (component: React.Component) => () => new Promise(resolve => component.forceUpdate(() => resolve(undefined)));
